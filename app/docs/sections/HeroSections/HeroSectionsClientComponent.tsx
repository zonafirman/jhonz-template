...
const simpleCenterCode = `<section class="bg-white dark:bg-slate-900">
    <div class="py-8 px-4 mx-auto text-center lg:py-16">
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                Get started
...
const withImageCode = `<section class="bg-white dark:bg-slate-900">
    <div class="grid max-w-7xl px-4 py-8 mx-auto lg:gap-8 xl:gap-16 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                Get started
...
const gradientHeroCode = `<section class="bg-gradient-to-b from-blue-50 to-white dark:from-slate-800 dark:to-slate-900">
...
const portfolioHeroCode = `<section class="bg-gradient-to-b from-blue-50 to-white dark:from-slate-800 dark:to-slate-900">
...
const saasHeroCode = `<section class="bg-gradient-to-b from-blue-50 to-white dark:from-slate-800 dark:to-slate-900">
...
const futuristicGridHeroCode = `<section class="relative bg-slate-900 text-white py-20 sm:py-24 overflow-hidden">
    <div class="absolute inset-0 bg-grid-slate-800/50 [mask-image:linear-gradient(to_bottom,white_20%,transparent_100%)]"></div>
    <div class="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_var(--x,50%)_var(--y,50%),rgba(59,130,246,0.15),transparent_40%)]"></div>
        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-3">
            <div class="flex flex-col justify-center text-center lg:text-left lg:col-span-2">
                ...
                <div class="mt-8 flex justify-center lg:justify-start gap-4">
                    <a href="#" class="inline-flex items-center justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-blue-700 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900 sm:px-5 sm:py-3 sm:text-base">
                        Request a Demo
                    </a>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4 sm:gap-6">
                <div class="rounded-xl bg-slate-800/50 p-4 sm:p-6 text-center transition-all duration-300 hover:bg-slate-800 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20">
                    <div class="text-3xl sm:text-4xl font-bold text-blue-400">40%</div>
                    <p class="mt-2 text-sm font-medium text-slate-400">Faster Integration</p>
                </div>
                <div class="rounded-xl bg-slate-800/50 p-4 sm:p-6 text-center transition-all duration-300 hover:bg-slate-800 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20">
                    <div class="text-3xl sm:text-4xl font-bold text-blue-400">99.9%</div>
                    <p class="mt-2 text-sm font-medium text-slate-400">Uptime SLA</p>
                </div>
                <div class="col-span-2 rounded-xl bg-slate-800/50 p-4 sm:p-6 text-center transition-all duration-300 hover:bg-slate-800 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20">
    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
            <div class="flex flex-col justify-center transition-all duration-300 ease-out hover:-translate-y-1">
                ...
                <div class="mt-8">
                    <a href="#" class="inline-flex items-center justify-center rounded-lg bg-blue-700 px-6 py-3 text-base font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-blue-800 hover:shadow-2xl hover:shadow-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Explore Features
                    </a>
                </div>
            </div>
            <div class="mt-12 lg:mt-0">
                <div class="relative -mx-4 lg:mx-0">
                    <img class="w-full lg:w-auto lg:max-w-none lg:absolute lg:left-1/2 lg:-translate-x-1/4 rounded-2xl shadow-2xl transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30 dark:hover:shadow-blue-400/20" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/dashboard-mockup-dark.svg" alt="Dashboard mockup" width="1024" height="683">
                </div>
            </div>
        </div>
    </div>
...
const videoHeroCode = `<section class="relative bg-slate-900 text-white">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-12 lg:py-24">
        <div class="flex flex-col justify-center lg:col-span-6">
            <span class="mb-4 inline-block rounded-full bg-blue-600/10 px-3 py-1 text-sm font-semibold text-blue-400 w-fit">New for 2025</span>
            ...
            <div class="mt-8 flex gap-4">
                <a href="#" class="inline-flex items-center justify-center rounded-lg bg-blue-600 px-5 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">Watch Demo</a>
            </div>
        </div>
...
const featureListHeroCode = `<section class="bg-white dark:bg-slate-900">
    <div class="grid max-w-7xl px-4 py-8 mx-auto lg:gap-8 xl:gap-16 lg:py-16 lg:grid-cols-12">
        <div class="flex flex-col justify-center lg:col-span-7">
            ...
            <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 w-fit">Get started</a>
        </div>
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
...
const interactiveCardStackHeroCode = `<section class="relative bg-slate-900 text-white overflow-hidden py-20 sm:py-32">
    <div class="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-120 h-120 bg-linear-to-tr from-blue-600 to-purple-600 rounded-full opacity-20 blur-3xl"></div>
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="text-center lg:text-left">
                ...
                <div class="mt-8 flex justify-center lg:justify-start">
                    <a href="#" class="inline-flex items-center justify-center rounded-lg bg-blue-600 px-6 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">
                        Explore Now
                    </a>
                </div>
            </div>
...
const gradientSpotlightHeroCode = `<section class="relative bg-slate-900 text-white py-20 sm:py-32">
    <div class="pointer-events-none absolute inset-0 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-radial-at-center from-blue-500/10 to-transparent to-70%"></div>
    </div>
    <div class="relative mx-auto max-w-4xl text-center px-4">
        <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
...
const auroraHeroCode = `<section class="relative bg-slate-900 py-20 sm:py-32 overflow-hidden">
    ...
    <div class="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2">
        <div class="w-160 h-160 bg-linear-to-tr from-cyan-400 to-emerald-400 rounded-full animate-spin-slow-reverse opacity-30 blur-3xl"></div>
    </div>
    <div class="relative mx-auto max-w-4xl text-center px-4">
        <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
...
const interactiveGridHoverCode = `<section class="relative bg-slate-900 text-white py-20 sm:py-32 overflow-hidden">
    ...
    <div class="relative mx-auto max-w-4xl text-center px-4">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
            <a href="#" class="rounded-md bg-blue-600 px-5 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">
                Explore Network
            </a>
        </div>
    </div>
...
const animatedGridHeroCode = `<section class="relative bg-slate-900 text-white py-20 sm:py-32 overflow-hidden">
    <div class="absolute inset-0 bg-grid-slate-800/50 mask-[linear-gradient(to_bottom,white_10%,transparent_50%)]"></div>
    <div class="absolute inset-0 pointer-events-none">
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(59,130,246,0.1),transparent_40%)]"></div>
        <div class="absolute top-1/2 left-1/2 w-[200%] h-[200%] -translate-x-1/2 -translate-y-1/2">
            <div class="absolute inset-0 animate-grid-pulse mask-[radial-gradient(500px_circle_at_center,white,transparent)]">
                <div class="absolute inset-0 bg-linear-to-r from-blue-500/30 to-transparent opacity-50 animate-grid-ray-1"></div>
                <div class="absolute inset-0 bg-linear-to-r from-blue-500/30 to-transparent opacity-50 animate-grid-ray-2"></div>
                <div class="absolute inset-0 bg-linear-to-r from-blue-500/30 to-transparent opacity-50 animate-grid-ray-3"></div>
            </div>
        </div>
    </div>
    <div class="relative mx-auto max-w-4xl text-center px-4">
  ...
  return (
    <>
        ...
        <section className="bg-white dark:bg-slate-900">
          <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 py-8 lg:grid-cols-12 lg:py-16 xl:gap-16">
            ...
            <div className="mt-8 text-center lg:col-span-7 lg:mt-0 lg:pl-12 lg:text-left">
              ...
              <p className="mx-auto max-w-2xl mb-6 font-light text-slate-500 dark:text-slate-400 md:text-lg lg:mb-8 lg:text-xl lg:mx-0">Experience the perfect blend of design and comfort. Built for the modern lifestyle.</p>
              <a href="#" className="mr-3 inline-flex items-center justify-center rounded-lg bg-blue-700 px-5 py-3 text-base font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-blue-800 hover:shadow-xl focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">Shop Now</a><a href="#" className="mt-4 inline-flex items-center justify-center rounded-lg border border-slate-300 px-5 py-3 text-base font-medium text-slate-900 transition-all duration-300 hover:-translate-y-1 hover:bg-slate-100 focus:ring-4 focus:ring-slate-100 dark:border-slate-700 dark:text-white dark:hover:bg-slate-700 dark:focus:ring-slate-800 sm:mt-0">Explore Collection</a>
            </div>
          </div>
        </section>
      </CodePreview>
      ...
      <CodePreview code={saasHeroCode}>
        <section className="bg-gradient-to-b from-blue-50 to-white dark:from-slate-800 dark:to-slate-900">
          <div className="mx-auto max-w-7xl px-4 py-8 lg:py-16">
            <div className="mb-8 rounded-lg border border-slate-200 bg-white p-8 shadow-md transition-shadow duration-300 hover:shadow-xl dark:border-slate-700 dark:bg-slate-800 md:p-12">
              ...
              <a href="#" className="inline-flex transform items-center justify-center rounded-lg bg-blue-700 py-3 px-5 text-base font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-blue-800 hover:shadow-xl focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Get a free demo
      ...
      >
        <CodePreview code={futuristicGridHeroCode}>
          <section className="relative overflow-hidden bg-slate-900 py-20 text-white sm:py-24">
            <div className="absolute inset-0 bg-grid-slate-800/50 [mask-image:linear-gradient(to_bottom,white_20%,transparent_100%)]" />
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_var(--x,50%)_var(--y,50%),rgba(59,130,246,0.15),transparent_40%)]" />
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
                <div className="flex flex-col justify-center text-center lg:col-span-2 lg:text-left">
                  ...
                  <div className="mt-8 flex justify-center gap-4 lg:justify-start">
                    <a href="#" className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-blue-700 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900 sm:px-5 sm:py-3 sm:text-base">
                      Request a Demo
                    </a>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4 sm:gap-6">
                  <div className="rounded-xl bg-slate-800/50 p-4 text-center transition-all duration-300 hover:scale-105 hover:bg-slate-800 hover:shadow-2xl hover:shadow-blue-500/20 sm:p-6">
                    <div className="text-3xl font-bold text-blue-400 sm:text-4xl">40%</div>
                    <p className="mt-2 text-sm font-medium text-slate-400">Faster Integration</p>
                  </div>
                  <div className="rounded-xl bg-slate-800/50 p-4 text-center transition-all duration-300 hover:scale-105 hover:bg-slate-800 hover:shadow-2xl hover:shadow-blue-500/20 sm:p-6">
                    <div className="text-3xl font-bold text-blue-400 sm:text-4xl">99.9%</div>
                    <p className="mt-2 text-sm font-medium text-slate-400">Uptime SLA</p>
                  </div>
                  <div className="col-span-2 rounded-xl bg-slate-800/50 p-4 text-center transition-all duration-300 hover:scale-105 hover:bg-slate-800 hover:shadow-2xl hover:shadow-blue-500/20 sm:p-6">
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center transition-all duration-300 ease-out hover:-translate-y-1">
                ...
                <div className="mt-8">
                  <a href="#" className="inline-flex items-center justify-center rounded-lg bg-blue-700 px-6 py-3 text-base font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-blue-800 hover:shadow-2xl hover:shadow-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Explore Features</a>
                </div>
              </div>
              <div className="relative mt-12 lg:mt-0">
                <div className="relative -mx-4 lg:mx-0"><Image width={1024} height={683} className="w-full rounded-2xl shadow-2xl transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30 lg:absolute lg:left-1/2 lg:w-auto lg:max-w-none lg:-translate-x-1/4 dark:hover:shadow-blue-400/20" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/dashboard-mockup-dark.svg" alt="Dashboard mockup" /></div>
              </div>
            </div>
          </div>
        </section>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Desain modern untuk 2025 dengan tata letak split-screen yang menampilkan video di satu sisi untuk menarik perhatian, dan pesan utama di sisi lain untuk mendorong konversi.</p>
        ...
        <section className="relative bg-slate-900 text-white">
          <div className="mx-auto grid max-w-7xl grid-cols-12 gap-12 px-4 py-16 sm:px-6 lg:py-24">
            <div className="flex flex-col justify-center lg:col-span-6">
              <span className="mb-4 inline-block w-fit rounded-full bg-blue-600/10 px-3 py-1 text-sm font-semibold text-blue-400">New for 2025</span>
              ...
              <div className="mt-8 flex gap-4"><a href="#" className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-5 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">Watch Demo</a></div>
            </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak modern untuk 2025 yang menggabungkan judul yang kuat dengan daftar fitur utama dan tangkapan layar produk. Ideal untuk halaman arahan SaaS atau aplikasi.</p>
        ...
        <section className="bg-white dark:bg-slate-900">
          <div className="mx-auto grid max-w-7xl grid-cols-12 gap-8 px-4 py-8 xl:gap-16 lg:py-16">
            <div className="flex flex-col justify-center lg:col-span-7">
              ...
              <a href="#" className="mr-3 inline-flex w-fit items-center justify-center rounded-lg bg-blue-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">Get started</a>
            </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak yang unik dan interaktif untuk 2025. Menampilkan tumpukan kartu yang merespons saat kursor diarahkan, menciptakan pengalaman yang menarik secara visual untuk menyoroti fitur-fitur utama.</p>
      <CodePreview code={interactiveCardStackHeroCode}>
        <section className="relative overflow-hidden bg-slate-900 py-20 text-white sm:py-32">
          <div className="absolute left-0 top-0 h-120 w-120 -translate-x-1/2 -translate-y-1/2 rounded-full bg-linear-to-tr from-blue-600 to-purple-600 opacity-20 blur-3xl" />
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div className="text-center lg:text-left">
                ...
                <div className="mt-8 flex justify-center lg:justify-start">
                  <a href="#" className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-6 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">Explore Now</a>
                </div>
              </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak unik untuk 2025 dengan efek sorotan interaktif. Bingkai bercahaya memiliki animasi sendiri dan akan semakin intens saat kursor diarahkan, menarik perhatian ke pesan utama.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak modern untuk 2025 dengan sorotan gradien interaktif yang mengikuti kursor Anda, menciptakan pengalaman visual yang dinamis dan menarik.</p>
      <div
        ...
        <CodePreview code={gradientSpotlightHeroCode}>
          <section className="relative bg-slate-900 py-20 text-white sm:py-32">
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              <div className="absolute inset-0 bg-[radial-gradient(600px_circle_at_var(--x)_var(--y),rgba(29,78,216,0.15),transparent_80%)]" />
            </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak yang unik dan jarang terlihat untuk tahun 2025, menampilkan efek latar belakang aurora yang dinamis. Desain ini menciptakan suasana futuristik dan profesional.</p>
      <CodePreview code={auroraHeroCode}>
        <section className="relative overflow-hidden bg-slate-900 py-20 sm:py-32">
          <div className="absolute left-0 top-0 -translate-x-1/2 -translate-y-1/2">
            <div className="h-160 w-160 animate-spin-slow rounded-full bg-linear-to-tr from-violet-600 to-blue-600 opacity-30 blur-3xl" />
          </div>
          <div className="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2">
            <div className="h-160 w-160 animate-spin-slow-reverse rounded-full bg-linear-to-tr from-cyan-400 to-emerald-400 opacity-30 blur-3xl" />
          </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak modern dan interaktif untuk 2025. Menampilkan kartu 3D yang merespons saat kursor diarahkan, menciptakan efek pergeseran perspektif yang unik dan menarik secara visual.</p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto grid max-w-2xl items-center gap-16 lg:max-w-none lg:grid-cols-2">
              <div className="text-center lg:text-left">
                ...
                <div className="mt-8 flex justify-center lg:justify-start">
                  <a href="#" className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-6 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">
                    Get Started
                  </a>
                </div>
              </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak yang unik dan interaktif untuk 2025. Grid latar belakang akan menyala saat Anda menggerakkan kursor, menciptakan pengalaman dinamis dan menarik yang jarang terlihat.</p>
      <div
      ...
      >
        <CodePreview code={interactiveGridHoverCode}>
          <section className="relative bg-slate-900 py-20 text-white sm:py-32 overflow-hidden">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_var(--x)_var(--y),rgba(59,130,246,0.15),transparent_20%)]" />
            ...
            <div className="relative mx-auto max-w-4xl px-4 text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6"><a href="#" className="rounded-md bg-blue-600 px-5 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">Explore Network</a></div>
            </div>
          </section>
        </CodePreview>
      </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak unik untuk 2025 dengan pola grid animasi. Sorotan cahaya bergerak secara acak di latar belakang, menciptakan suasana berteknologi tinggi dan dinamis yang jarang terlihat.</p>
      <CodePreview code={animatedGridHeroCode}>
        <section className="relative overflow-hidden bg-slate-900 py-20 text-white sm:py-32">
          ...
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(59,130,246,0.1),transparent_40%)]" />
            <div className="absolute left-1/2 top-1/2 h-[200%] w-[200%] -translate-x-1/2 -translate-y-1/2">
              <div className="absolute inset-0 animate-grid-pulse mask-[radial-gradient(500px_circle_at_center,white,transparent)]">
                <div className="absolute inset-0 animate-grid-ray-1 bg-linear-to-r from-blue-500/30 to-transparent opacity-50" />
                <div className="absolute inset-0 animate-grid-ray-2 bg-linear-to-r from-blue-500/30 to-transparent opacity-50" />
                <div className="absolute inset-0 animate-grid-ray-3 bg-linear-to-r from-blue-500/30 to-transparent opacity-50" />
              </div>
            </div>
          </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Tata letak yang sangat unik dan interaktif untuk 2025. Arahkan kursor ke judul untuk melihat teks terurai menjadi partikel. Efek ini menciptakan pengalaman yang tak terlupakan dan futuristik.</p>
      <CodePreview code={textParticleHeroCode}>
        <div className="relative w-full overflow-hidden bg-slate-900 py-20 text-white sm:py-32">
          ...
          <div className="relative mx-auto max-w-4xl px-4 text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a href="#" className="rounded-md bg-blue-600 px-5 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700">
                Get Started
              </a>
            </div>
          </div>
