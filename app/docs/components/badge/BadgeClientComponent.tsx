...
export default function BadgeClientComponent() {
  return (
    <>
      <h2 id="simple-badges" className="mt-12 scroll-mt-20 text-3xl font-bold">
        Simple Badges
      </h2>
      <p className="mt-4 text-slate-600 dark:text-slate-400">Basic badges with solid background colors to draw attention to an element.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Use the `rounded-full` utility to create pill-shaped badges.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Badges with a transparent background and a colored border for a more subtle appearance.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Include an icon within a badge to provide additional context, such as a status indicator.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">A modern badge for notifications, featuring a ping animation to draw the user&apos;s attention to new updates.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">A modern, animated badge with a glowing effect created by a spinning conic gradient. Ideal for dark mode interfaces to highlight a status in a visually striking way.</p>
      <CodePreview code={glowingBadgeCode}>
        <div className="flex flex-wrap items-center gap-4">
          <span className="relative inline-flex overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-900 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">In Progress</span>
          </span>
          <span className="relative inline-flex overflow-hidden rounded-full p-[1px]">
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-900 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">Completed</span>
          </span>
        </div>
      </CodePreview>
    </>
