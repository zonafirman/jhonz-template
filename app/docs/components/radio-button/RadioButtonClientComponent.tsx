...
export default function RadioButtonClientComponent() {
  return (
    <>
      ...
      <CodePreview code={basicUsageCode}>
        <div className="flex items-center">
          ...
          <label htmlFor="default-radio" className="ml-2 text-sm font-medium text-slate-900 dark:text-slate-300">
            Default radio
          </label>
        </div>
      </CodePreview>
      ...
      <CodePreview code={disabledStateCode}>
        <div className="flex items-center">
          ...
          <label htmlFor="disabled-radio" className="ml-2 text-sm font-medium text-slate-400 dark:text-slate-500">
            Disabled radio
          </label>
        </div>
      </CodePreview>
      ...
      <CodePreview code={radioGroupCode}>
        <fieldset>
          ...
          <div className="mb-4 flex items-center">
            ...
            <label htmlFor="country-1" className="ml-2 text-sm font-medium text-slate-900 dark:text-slate-300">
              United States
            </label>
          </div>
          <div className="flex items-center">
            ...
            <label htmlFor="country-2" className="ml-2 text-sm font-medium text-slate-900 dark:text-slate-300">
              Germany
            </label>
          </div>
        </fieldset>
      ...
      <CodePreview code={withDescriptionCode}>
        <div className="flex items-start">
          ...
          <div className="ml-2 text-sm">
            <label htmlFor="with-description" className="font-medium text-slate-900 dark:text-slate-300">
              Social media
            </label>
        ...
        <ul className="w-full max-w-md rounded-lg border border-slate-200 bg-white text-sm font-medium text-slate-900 dark:border-slate-600 dark:bg-slate-700 dark:text-white">
          <li className="w-full rounded-t-lg border-b border-slate-200 dark:border-slate-600">
            <div className="flex items-center pl-3">
              ...
              <label htmlFor="list-radio-license" className="ml-2 w-full py-3 text-sm font-medium text-slate-900 dark:text-slate-300">
                MIT License
              </label>
            </div>
          </li>
          <li className="w-full border-b border-slate-200 dark:border-slate-600">
            <div className="flex items-center pl-3">
              ...
              <label htmlFor="list-radio-id" className="ml-2 w-full py-3 text-sm font-medium text-slate-900 dark:text-slate-300">
                Apache 2.0
              </label>
            </div>
          </li>
          <li className="w-full rounded-b-lg">
            <div className="flex items-center pl-3">
              ...
              <label htmlFor="list-radio-millitary" className="ml-2 w-full py-3 text-sm font-medium text-slate-900 dark:text-slate-300">
                GNU GPL v3
              </label>
            </div>
          </li>
