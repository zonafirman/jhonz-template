...
const stepperWithIconsCode = `<ol class="flex items-center w-full">
    ...
    <li class="flex items-center w-full">
        <span class="flex items-center justify-center w-10 h-10 bg-slate-100 rounded-full lg:h-12 lg:w-12 dark:bg-slate-700 shrink-0">
            <svg class="w-4 h-4 text-slate-500 lg:w-6 lg:h-6 dark:text-slate-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20"><path d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.992 1.992 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2Zm-3 14H5a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Zm0-4H5a1 1 0 0 1 0-2h8a1 1 0 1 1 0 2Zm0-4H5a1 1 0 0 1 0-2h8a1 1考え 0 2Z"/></svg>
        </span>
    </li>
</ol>`;
    ...
    <div className="flex w-full">
      <article className="min-w-0 flex-1 pe-8">
        ...
        <CodePreview code={stepperWithIconsCode}>
          <div dangerouslySetInnerHTML={{ __html: stepperWithIconsCode }} />
        </CodePreview>
