...
export default function SpinnerClientComponent() {
  return (
    <>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">
        Sesuaikan warna spinner menggunakan kelas utilitas <code>fill-{'{'}color{'}'}</code> dari Tailwind CSS.
      </p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">
        Gunakan kelas utilitas <code>w-{'{'}size{'}'}</code> dan <code>h-{'{'}size{'}'}</code> dari Tailwind CSS untuk mengubah ukuran spinner.
      </p>
