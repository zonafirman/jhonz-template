...
export default function PaginationClientComponent() {
  return (
    <>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Contoh dasar pagination dengan tombol Previous/Next dan nomor halaman. Gunakan `aria-current=&quot;page&quot;` untuk menandai halaman yang aktif.</p>
      <CodePreview code={basicUsageCode}>
        <nav aria-label="Page navigation">
          <ul className="inline-flex -space-x-px text-sm">
            ...
            <li>
              <a href="#" className="flex h-10 items-center justify-center border border-slate-300 bg-white px-4 leading-tight text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-white">
                1
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#" aria-current="page" className="z-10 flex h-10 items-center justify-center border border-blue-300 bg-blue-50 px-4 leading-tight text-blue-600 hover:bg-blue-100 hover:text-blue-700 dark:border-slate-700 dark:bg-slate-700 dark:text-white">
                3
              </a>
            </li>
            <li>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Gunakan ikon untuk tombol Previous dan Next untuk tampilan yang lebih ringkas. Pastikan untuk menyertakan teks `sr-only` untuk aksesibilitas.</p>
      <CodePreview code={withIconsCode}>
        <nav aria-label="Page navigation">
          <ul className="inline-flex -space-x-px text-sm">
            ...
            <li>
              <a href="#" aria-current="page" className="z-10 flex h-10 items-center justify-center border border-blue-300 bg-blue-50 px-4 text-blue-600 hover:bg-blue-100 hover:text-blue-700 dark:border-slate-700 dark:bg-slate-700 dark:text-white">
                2
              </a>
            </li>
            <li>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Untuk navigasi yang lebih sederhana, Anda bisa hanya menampilkan tombol Previous dan Next.</p>
      <CodePreview code={prevNextOnlyCode}>
        <div className="flex w-full max-w-xs items-center justify-between">
          <a href="#" className="inline-flex items-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-white">
            Previous
          </a>
          <a href="#" className="inline-flex items-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-white">
            Next
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Contoh pagination dengan gaya yang lebih modern, menggunakan sudut yang membulat dan efek transisi yang halus untuk pengalaman pengguna yang lebih baik.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Untuk set data yang besar, gunakan pagination canggih dengan tombol halaman pertama/terakhir dan elipsis. Gaya ini menggunakan tombol bulat untuk tampilan yang lebih modern dan profesional.</p>
      <CodePreview code={advancedPaginationCode}>
        <nav aria-label="Advanced page navigation">
          <ul className="flex items-center space-x-2 text-sm">
            ...
            <li>
              <a href="#" className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white px-3.5 text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-white">
                1
              </a>
            </li>
            <li>
              <a href="#" aria-current="page" className="z-10 flex h-9 w-9 items-center justify-center rounded-full border border-blue-500 bg-blue-500 px-3.5 font-medium text-white dark:border-blue-400 dark:bg-blue-600">
                2
              </a>
            </li>
            <li>
            ...
            <li>
              <span className="flex h-9 w-9 items-center justify-center px-3.5 text-slate-500 dark:text-slate-400">...</span>
            </li>
            <li>
              <a href="#" className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white px-3.5 text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-white">
                10
            ...
            <li>
              <a href="#" className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 dark:hover:text-white">
                ...
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M4.293 4.293a1 1 0 011.414 0l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414zm6 0a1 1 0 011.414 0l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414-1.414L14.586 10l-4.293-4.293z" />
                </svg>
              </a>
            </li>
          </ul>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Gaya pagination yang bersih dan minimalis tanpa border. Halaman aktif ditandai dengan latar belakang berwarna dan bayangan lembut, menciptakan tampilan yang modern dan profesional untuk 2025.</p>
      <CodePreview code={minimalistPaginationCode}>
        <nav aria-label="Minimalist page navigation">
          <ul className="flex items-center -space-x-1 text-sm">
            ...
            <li>
              <a href="#" className="flex h-9 w-9 items-center justify-center rounded-full text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-700">
                1
              </a>
            </li>
            <li>
              <a href="#" aria-current="page" className="z-10 flex h-9 w-9 items-center justify-center rounded-full bg-blue-600 font-semibold text-white shadow-md">
                2
              </a>
            </li>
            <li>
