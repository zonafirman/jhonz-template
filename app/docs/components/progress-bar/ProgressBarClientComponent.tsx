...
export default function ProgressBarClientComponent() {
  return (
    <>
      <h2 id="basic-usage" className="mt-12 scroll-mt-20 text-3xl font-bold">
        Basic Usage
      </h2>
      <p className="mt-4 text-slate-600 dark:text-slate-400">Contoh paling dasar dari progress bar. Lebar dari progress bar diatur menggunakan inline style `width`.</p>
      <CodePreview code={basicUsageCode}>
        <div className="w-full rounded-full bg-slate-200 dark:bg-slate-700">
          <div className="rounded-full bg-blue-600 p-0.5 text-center text-xs font-medium leading-none text-blue-100" style={{ width: '45%' }}>
            {' '}
            45%
          </div>
        </div>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Anda dapat menambahkan label di luar progress bar untuk memberikan konteks tambahan mengenai kemajuan yang ditampilkan.</p>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Gunakan warna yang berbeda untuk menandakan status yang berbeda, seperti sukses (hijau), peringatan (kuning), atau kesalahan (merah).</p>
      <CodePreview code={differentColorsCode}>
        <div className="space-y-4">
          <div className="w-full rounded-full bg-slate-200 dark:bg-slate-700"><div className="h-2.5 rounded-full bg-blue-600" style={{ width: '45%' }}></div></div>
          <div className="w-full rounded-full bg-slate-200 dark:bg-slate-700"><div className="h-2.5 rounded-full bg-red-600 dark:bg-red-500" style={{ width: '55%' }}></div></div>
          <div className="w-full rounded-full bg-slate-200 dark:bg-slate-700"><div className="h-2.5 rounded-full bg-green-600 dark:bg-green-500" style={{ width: '65%' }}></div></div>
          <div className="w-full rounded-full bg-slate-200 dark:bg-slate-700"><div className="h-2.5 rounded-full bg-yellow-400" style={{ width: '75%' }}></div></div>
          <div className="w-full rounded-full bg-slate-200 dark:bg-slate-700"><div className="h-2.5 rounded-full bg-indigo-600 dark:bg-indigo-500" style={{ width: '85%' }}></div></div>
        </div>
      </CodePreview>
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-400">Sesuaikan ukuran tinggi progress bar menggunakan kelas utilitas tinggi dari Tailwind CSS, seperti `h-1.5`, `h-2.5`, `h-4`, atau `h-6`.</p>
