  ...
  return (
    <div className="flex w-full">
      <article className="min-w-0 flex-1 pe-8">
        ...
        <p className="mt-4 text-slate-600 dark:text-slate-400">
          Gunakan elemen `&lt;label&gt;` yang terhubung dengan sebuah input melalui atribut `for`. Ini adalah praktik standar untuk form yang aksesibel.
        </p>
        ...
        <p className="mt-4 text-slate-600 dark:text-slate-400">
          Tambahkan indikator, seperti tanda bintang, untuk memberitahu pengguna bahwa sebuah field wajib diisi.
        </p>
